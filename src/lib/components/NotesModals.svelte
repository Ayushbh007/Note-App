<script lang="ts">
	...
	let { showCreate, editingNote, deletingNote, isSubmitting, onCreate, onUpdate, onDeleteConfirm, onCloseModals }: Props = $props();
</script>

<Modal isOpen={showCreate || editingNote !== null} onClose={onCloseModals} title={editingNote ? 'Edit Note' : 'Create Note'}>
	<NoteForm
...
<Modal isOpen={deletingNote !== null} onClose={onCloseModals} title="Delete Note" size="sm">
	<div class="space-y-4">
