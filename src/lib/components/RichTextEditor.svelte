...
<div
  class="rich-text-editor rounded-xl border border-gray-300 dark:border-gray-600 overflow-hidden {disabled
    ? 'opacity-50'
    : ''}"
>
  <div
    class="flex flex-wrap gap-1 p-2 bg-slate-100 dark:bg-slate-700/50 border-b border-gray-300 dark:border-gray-600"
  >
    <button
      type="button"
